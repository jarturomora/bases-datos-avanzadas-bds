...
### 3.4 CONNECTED_TO (Persona ↔ Persona)

En el CSV viene como pares `personId1`, `personId2`. Creamos una relación dirigida (en la práctica puedes tratarla como “simétrica” consultando en ambos sentidos).
